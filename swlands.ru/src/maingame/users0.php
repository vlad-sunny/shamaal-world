...
$player['show'] = 0;
$show = 0;
echo "<html>\r\n<head>\r\n\t<title>Shamaal World</title>\r\n<meta content=\"text/html; charset=utf-8\" http-equiv=\"Content-Type\"><LINK REL=STYLESHEET TYPE=\"TEXT/CSS\" HREF=\"style.css\" TITLE=\"STYLE\"></head>\r\n
...
print $player_name;
echo '" target="_blank"><img src=pic/game/info.gif width=13 height=13></a></td><td width=18> </td><td width=18><img src=pic/game/attack.gif width=15 height=15></td><td width=20>[<a onclick="top.textenter(\'/приват ';
print $player_name;
echo '\');" style=cursor:hand><font color=00237B><b>П</b></font></a>]</td><td class=usergood><a onclick=top.entertext("';
print $player_name;
